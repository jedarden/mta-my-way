      ...
      recordTrip(
        {
          ...
          destination: { stationId: "725", stationName: "Times Sq-42 St" },
          line: "1",
          departureTime: Math.floor((now - 5400000) / 1000),
          arrivalTime: Math.floor(now / 1000) - 1800000,
          actualDurationMinutes: 70,
          source: "manual",
        },
        TEST_OWNER_2
      ...
      const trip = recordInferredTrip(
        {
          ...
          originId: "101",
          destinationId: "725",
          departureTime: Math.floor((now - 3600) / 1000),
          arrivalTime: Math.floor(now / 1000),
        },
        TEST_OWNER_1
      );
      ...
      const trip = recordInferredTrip(
        {
          ...
          originId: "726",
          destinationId: "727",
          departureTime: now - 2400, // 40 minutes = 2400 seconds
          arrivalTime: now,
        },
        TEST_OWNER_1
      );
      ...
      recordTrip(
        {
          ...
          destination: { stationId: "725", stationName: "Times Sq-42 St" },
          line: "1",
          departureTime: Math.floor((now - 100000000) / 1000),
          arrivalTime: Math.floor(now / 1000) - 99640000,
          actualDurationMinutes: 60,
          source: "manual",
        },
        TEST_OWNER_1
      ...
      recordTrip(
        {
          ...
          destination: { stationId: "725", stationName: "Times Sq-42 St" },
          line: "1",
          departureTime: Math.floor((now - 90000000) / 1000),
          arrivalTime: Math.floor(now / 1000) - 89640000,
          actualDurationMinutes: 60,
          source: "inferred",
        },
        TEST_OWNER_1
      ...
      recordTrip(
        {
          ...
          destination: { stationId: "726", stationName: "42 St-Port Authority" },
          line: "A",
          departureTime: Math.floor((now - 80000000) / 1000),
          arrivalTime: Math.floor(now / 1000) - 79640000,
          actualDurationMinutes: 60,
          source: "tracked",
        },
        TEST_OWNER_2
