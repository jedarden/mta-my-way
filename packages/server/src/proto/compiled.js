    ...
    transit_realtime.FeedHeader = (function() {
        ...
        FeedHeader.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        message[".transit_realtime.nyctFeedHeader"] = $root.transit_realtime.NyctFeedHeader.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        FeedHeader.verify = function verify(message, long) {
            ...
            if (message[".transit_realtime.nyctFeedHeader"] != null && message.hasOwnProperty(".transit_realtime.nyctFeedHeader")) {
                let error = $root.transit_realtime.NyctFeedHeader.verify(message[".transit_realtime.nyctFeedHeader"], long + 1);
                if (error)
        ...
        FeedHeader.fromObject = function fromObject(object, long) {
            ...
            if (object[".transit_realtime.nyctFeedHeader"] != null) {
                ...
                message[".transit_realtime.nyctFeedHeader"] = $root.transit_realtime.NyctFeedHeader.fromObject(object[".transit_realtime.nyctFeedHeader"], long + 1);
            }
            return message;
        };
    ...
    transit_realtime.FeedEntity = (function() {
        ...
        FeedEntity.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 3: {
                        message.tripUpdate = $root.transit_realtime.TripUpdate.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 4: {
        ...
        FeedEntity.fromObject = function fromObject(object, long) {
            ...
            if (object.tripUpdate != null) {
                ...
                message.tripUpdate = $root.transit_realtime.TripUpdate.fromObject(object.tripUpdate, long + 1);
            }
    ...
    transit_realtime.TripUpdate = (function() {
        ...
        TripUpdate.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 2: {
                        ...
                        message.stopTimeUpdate.push($root.transit_realtime.TripUpdate.StopTimeUpdate.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                case 4: {
                        message.timestamp = reader.uint64();
                ...
                case 6: {
                        message.tripProperties = $root.transit_realtime.TripUpdate.TripProperties.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        TripUpdate.verify = function verify(message, long) {
            ...
            if (message.stopTimeUpdate != null && message.hasOwnProperty("stopTimeUpdate")) {
                ...
                for (let i = 0; i < message.stopTimeUpdate.length; ++i) {
                    let error = $root.transit_realtime.TripUpdate.StopTimeUpdate.verify(message.stopTimeUpdate[i], long + 1);
                    if (error)
            ...
            if (message.tripProperties != null && message.hasOwnProperty("tripProperties")) {
                let error = $root.transit_realtime.TripUpdate.TripProperties.verify(message.tripProperties, long + 1);
                if (error)
        ...
        TripUpdate.fromObject = function fromObject(object, long) {
            ...
            if (object.stopTimeUpdate) {
                ...
                for (let i = 0; i < object.stopTimeUpdate.length; ++i) {
                    ...
                    message.stopTimeUpdate[i] = $root.transit_realtime.TripUpdate.StopTimeUpdate.fromObject(object.stopTimeUpdate[i], long + 1);
                }
            }
            if (object.timestamp != null)
                if ($util.Long)
            ...
            if (object.tripProperties != null) {
                ...
                message.tripProperties = $root.transit_realtime.TripUpdate.TripProperties.fromObject(object.tripProperties, long + 1);
            }
            return message;
        };
        ...
        TripUpdate.StopTimeUpdate = (function() {
            ...
            StopTimeUpdate.decode = function decode(reader, length, error, long) {
                ...
                while (reader.pos < end) {
                    ...
                    case 6: {
                            message.stopTimeProperties = $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.decode(reader, reader.uint32(), undefined, long + 1);
                            break;
                        }
                    case 1001: {
                            message[".transit_realtime.nyctStopTimeUpdate"] = $root.transit_realtime.NyctStopTimeUpdate.decode(reader, reader.uint32(), undefined, long + 1);
                            break;
                        }
                    default:
                        reader.skipType(tag & 7, long);
            ...
            StopTimeUpdate.verify = function verify(message, long) {
                ...
                if (message.stopTimeProperties != null && message.hasOwnProperty("stopTimeProperties")) {
                    let error = $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.verify(message.stopTimeProperties, long + 1);
                    if (error)
                ...
                if (message[".transit_realtime.nyctStopTimeUpdate"] != null && message.hasOwnProperty(".transit_realtime.nyctStopTimeUpdate")) {
                    let error = $root.transit_realtime.NyctStopTimeUpdate.verify(message[".transit_realtime.nyctStopTimeUpdate"], long + 1);
                    if (error)
            ...
            StopTimeUpdate.fromObject = function fromObject(object, long) {
                ...
                if (object.stopTimeProperties != null) {
                    ...
                    message.stopTimeProperties = $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.fromObject(object.stopTimeProperties, long + 1);
                }
                if (object[".transit_realtime.nyctStopTimeUpdate"] != null) {
                    ...
                    message[".transit_realtime.nyctStopTimeUpdate"] = $root.transit_realtime.NyctStopTimeUpdate.fromObject(object[".transit_realtime.nyctStopTimeUpdate"], long + 1);
                }
                return message;
            };
    ...
    transit_realtime.VehiclePosition = (function() {
        ...
        VehiclePosition.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 11: {
                        ...
                        message.multiCarriageDetails.push($root.transit_realtime.VehiclePosition.CarriageDetails.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        VehiclePosition.verify = function verify(message, long) {
            ...
            if (message.multiCarriageDetails != null && message.hasOwnProperty("multiCarriageDetails")) {
                ...
                for (let i = 0; i < message.multiCarriageDetails.length; ++i) {
                    let error = $root.transit_realtime.VehiclePosition.CarriageDetails.verify(message.multiCarriageDetails[i], long + 1);
                    if (error)
        ...
        VehiclePosition.fromObject = function fromObject(object, long) {
            ...
            if (object.multiCarriageDetails) {
                ...
                for (let i = 0; i < object.multiCarriageDetails.length; ++i) {
                    ...
                    message.multiCarriageDetails[i] = $root.transit_realtime.VehiclePosition.CarriageDetails.fromObject(object.multiCarriageDetails[i], long + 1);
                }
            }
            return message;
        };
    ...
    transit_realtime.Alert = (function() {
        ...
        Alert.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 1: {
                        ...
                        message.activePeriod.push($root.transit_realtime.TimeRange.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                case 5: {
                        if (!(message.informedEntity && message.informedEntity.length))
                            message.informedEntity = [];
                        message.informedEntity.push($root.transit_realtime.EntitySelector.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                case 6: {
                ...
                case 10: {
                        message.headerText = $root.transit_realtime.TranslatedString.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 11: {
                        message.descriptionText = $root.transit_realtime.TranslatedString.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 12: {
                        message.ttsHeaderText = $root.transit_realtime.TranslatedString.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 13: {
                        message.ttsDescriptionText = $root.transit_realtime.TranslatedString.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                case 14: {
        ...
        Alert.verify = function verify(message, long) {
            ...
            if (message.informedEntity != null && message.hasOwnProperty("informedEntity")) {
                ...
                for (let i = 0; i < message.informedEntity.length; ++i) {
                    let error = $root.transit_realtime.EntitySelector.verify(message.informedEntity[i], long + 1);
                    if (error)
            ...
            if (message.descriptionText != null && message.hasOwnProperty("descriptionText")) {
                let error = $root.transit_realtime.TranslatedString.verify(message.descriptionText, long + 1);
                if (error)
            ...
            if (message.ttsDescriptionText != null && message.hasOwnProperty("ttsDescriptionText")) {
                let error = $root.transit_realtime.TranslatedString.verify(message.ttsDescriptionText, long + 1);
                if (error)
        ...
        Alert.fromObject = function fromObject(object, long) {
            ...
            if (object.activePeriod) {
                ...
                for (let i = 0; i < object.activePeriod.length; ++i) {
                    ...
                    message.activePeriod[i] = $root.transit_realtime.TimeRange.fromObject(object.activePeriod[i], long + 1);
                }
            }
            if (object.informedEntity) {
                ...
                for (let i = 0; i < object.informedEntity.length; ++i) {
                    ...
                    message.informedEntity[i] = $root.transit_realtime.EntitySelector.fromObject(object.informedEntity[i], long + 1);
                }
            }
            switch (object.cause) {
            default:
            ...
            if (object.headerText != null) {
                ...
                message.headerText = $root.transit_realtime.TranslatedString.fromObject(object.headerText, long + 1);
            }
            if (object.descriptionText != null) {
                ...
                message.descriptionText = $root.transit_realtime.TranslatedString.fromObject(object.descriptionText, long + 1);
            }
            if (object.ttsHeaderText != null) {
                ...
                message.ttsHeaderText = $root.transit_realtime.TranslatedString.fromObject(object.ttsHeaderText, long + 1);
            }
            if (object.ttsDescriptionText != null) {
                ...
                message.ttsDescriptionText = $root.transit_realtime.TranslatedString.fromObject(object.ttsDescriptionText, long + 1);
            }
    ...
    transit_realtime.TripDescriptor = (function() {
        ...
        TripDescriptor.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 1001: {
                        message[".transit_realtime.nyctTripDescriptor"] = $root.transit_realtime.NyctTripDescriptor.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        TripDescriptor.verify = function verify(message, long) {
            ...
            if (message[".transit_realtime.nyctTripDescriptor"] != null && message.hasOwnProperty(".transit_realtime.nyctTripDescriptor")) {
                let error = $root.transit_realtime.NyctTripDescriptor.verify(message[".transit_realtime.nyctTripDescriptor"], long + 1);
                if (error)
        ...
        TripDescriptor.fromObject = function fromObject(object, long) {
            ...
            if (object[".transit_realtime.nyctTripDescriptor"] != null) {
                ...
                message[".transit_realtime.nyctTripDescriptor"] = $root.transit_realtime.NyctTripDescriptor.fromObject(object[".transit_realtime.nyctTripDescriptor"], long + 1);
            }
            return message;
        };
    ...
    transit_realtime.TripReplacementPeriod = (function() {
        ...
        TripReplacementPeriod.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 2: {
                        message.replacementPeriod = $root.transit_realtime.TimeRange.decode(reader, reader.uint32(), undefined, long + 1);
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        TripReplacementPeriod.fromObject = function fromObject(object, long) {
            ...
            if (object.replacementPeriod != null) {
                ...
                message.replacementPeriod = $root.transit_realtime.TimeRange.fromObject(object.replacementPeriod, long + 1);
            }
            return message;
        };
    ...
    transit_realtime.NyctFeedHeader = (function() {
        ...
        NyctFeedHeader.decode = function decode(reader, length, error, long) {
            ...
            while (reader.pos < end) {
                ...
                case 2: {
                        ...
                        message.tripReplacementPeriod.push($root.transit_realtime.TripReplacementPeriod.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        NyctFeedHeader.verify = function verify(message, long) {
            ...
            if (message.tripReplacementPeriod != null && message.hasOwnProperty("tripReplacementPeriod")) {
                ...
                for (let i = 0; i < message.tripReplacementPeriod.length; ++i) {
                    let error = $root.transit_realtime.TripReplacementPeriod.verify(message.tripReplacementPeriod[i], long + 1);
                    if (error)
        ...
        NyctFeedHeader.fromObject = function fromObject(object, long) {
            ...
            if (object.tripReplacementPeriod) {
                ...
                for (let i = 0; i < object.tripReplacementPeriod.length; ++i) {
                    ...
                    message.tripReplacementPeriod[i] = $root.transit_realtime.TripReplacementPeriod.fromObject(object.tripReplacementPeriod[i], long + 1);
                }
            }
            return message;
        };
