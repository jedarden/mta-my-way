...
export const transit_realtime = ($root.transit_realtime = (() => {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.entity.push(
              $root.transit_realtime.FeedEntity.decode(reader, reader.uint32(), undefined, long + 1)
            );
            break;
          }
          default:
  ...
  transit_realtime.FeedHeader = (function () {
    ...
    FeedHeader.encode = function encode(message, writer) {
      ...
      if (
        message[".transit_realtime.nyctFeedHeader"] != null &&
        Object.hasOwnProperty.call(message, ".transit_realtime.nyctFeedHeader")
      )
        $root.transit_realtime.NyctFeedHeader.encode(
    ...
    FeedHeader.decode = function decode(reader, length, error, long) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 1001: {
            message[".transit_realtime.nyctFeedHeader"] =
              $root.transit_realtime.NyctFeedHeader.decode(
                reader,
                reader.uint32(),
                undefined,
                long + 1
    ...
    FeedHeader.verify = function verify(message, long) {
      ...
      if (
        message[".transit_realtime.nyctFeedHeader"] != null &&
        message.hasOwnProperty(".transit_realtime.nyctFeedHeader")
      ) {
        let error = $root.transit_realtime.NyctFeedHeader.verify(
          message[".transit_realtime.nyctFeedHeader"],
          long + 1
        );
        if (error) return ".transit_realtime.nyctFeedHeader." + error;
      }
      return null;
    };
    ...
    FeedHeader.fromObject = function fromObject(object, long) {
      ...
      if (object[".transit_realtime.nyctFeedHeader"] != null) {
        if (typeof object[".transit_realtime.nyctFeedHeader"] !== "object")
          throw TypeError(
            ".transit_realtime.FeedHeader..transit_realtime.nyctFeedHeader: object expected"
          );
        message[".transit_realtime.nyctFeedHeader"] =
          $root.transit_realtime.NyctFeedHeader.fromObject(
            object[".transit_realtime.nyctFeedHeader"],
            long + 1
          );
      }
      return message;
    ...
    FeedHeader.toObject = function toObject(message, options) {
      ...
      if (message.incrementality != null && message.hasOwnProperty("incrementality"))
        object.incrementality =
          options.enums === String
            ? $root.transit_realtime.FeedHeader.Incrementality[message.incrementality] === undefined
              ? message.incrementality
              : $root.transit_realtime.FeedHeader.Incrementality[message.incrementality]
            : message.incrementality;
      if (message.timestamp != null && message.hasOwnProperty("timestamp"))
      ...
      if (
        ...
        object[".transit_realtime.nyctFeedHeader"] = $root.transit_realtime.NyctFeedHeader.toObject(
          message[".transit_realtime.nyctFeedHeader"],
          options
        );
      return object;
  ...
  transit_realtime.FeedEntity = (function () {
    ...
    FeedEntity.verify = function verify(message, long) {
      ...
      if (message.isDeleted != null && message.hasOwnProperty("isDeleted"))
        if (typeof message.isDeleted !== "boolean") return "isDeleted: boolean expected";
      if (message.tripUpdate != null && message.hasOwnProperty("tripUpdate")) {
        let error = $root.transit_realtime.TripUpdate.verify(message.tripUpdate, long + 1);
  ...
  transit_realtime.TripUpdate = (function () {
    ...
    TripUpdate.encode = function encode(message, writer) {
      ...
      if (message.tripProperties != null && Object.hasOwnProperty.call(message, "tripProperties"))
        $root.transit_realtime.TripUpdate.TripProperties.encode(
    ...
    TripUpdate.decode = function decode(reader, length, error, long) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 6: {
            message.tripProperties = $root.transit_realtime.TripUpdate.TripProperties.decode(
              reader,
              reader.uint32(),
              undefined,
              long + 1
    ...
    TripUpdate.verify = function verify(message, long) {
      ...
      if (message.tripProperties != null && message.hasOwnProperty("tripProperties")) {
        let error = $root.transit_realtime.TripUpdate.TripProperties.verify(
          message.tripProperties,
          long + 1
        );
        if (error) return "tripProperties." + error;
      }
      return null;
    };
    ...
    TripUpdate.fromObject = function fromObject(object, long) {
      ...
      if (object.stopTimeUpdate) {
        ...
        for (let i = 0; i < object.stopTimeUpdate.length; ++i) {
          ...
          message.stopTimeUpdate[i] = $root.transit_realtime.TripUpdate.StopTimeUpdate.fromObject(
      ...
      if (object.tripProperties != null) {
        ...
        message.tripProperties = $root.transit_realtime.TripUpdate.TripProperties.fromObject(
    ...
    TripUpdate.toObject = function toObject(message, options) {
      ...
      if (message.stopTimeUpdate && message.stopTimeUpdate.length) {
        ...
        for (let j = 0; j < message.stopTimeUpdate.length; ++j)
          object.stopTimeUpdate[j] = $root.transit_realtime.TripUpdate.StopTimeUpdate.toObject(
      ...
      if (message.tripProperties != null && message.hasOwnProperty("tripProperties"))
        object.tripProperties = $root.transit_realtime.TripUpdate.TripProperties.toObject(
          message.tripProperties,
          options
        );
      return object;
    ...
    TripUpdate.StopTimeEvent = (function () {
      ...
      StopTimeEvent.verify = function verify(message, long) {
        ...
        if (message.uncertainty != null && message.hasOwnProperty("uncertainty"))
          if (!$util.isInteger(message.uncertainty)) return "uncertainty: integer expected";
        return null;
      };
    ...
    TripUpdate.StopTimeUpdate = (function () {
      ...
      StopTimeUpdate.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "scheduleRelationship")
        )
          writer.uint32(/* id 5, wireType 0 =*/ 40).int32(message.scheduleRelationship);
        if (
          message.stopTimeProperties != null &&
          Object.hasOwnProperty.call(message, "stopTimeProperties")
        )
          $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.encode(
            message.stopTimeProperties,
            writer.uint32(/* id 6, wireType 2 =*/ 50).fork()
          ).ldelim();
        if (
          message[".transit_realtime.nyctStopTimeUpdate"] != null &&
          Object.hasOwnProperty.call(message, ".transit_realtime.nyctStopTimeUpdate")
        )
          $root.transit_realtime.NyctStopTimeUpdate.encode(
      ...
      StopTimeUpdate.decode = function decode(reader, length, error, long) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 6: {
              message.stopTimeProperties =
                $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  long + 1
            ...
            case 1001: {
              message[".transit_realtime.nyctStopTimeUpdate"] =
                $root.transit_realtime.NyctStopTimeUpdate.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  long + 1
      ...
      StopTimeUpdate.verify = function verify(message, long) {
        ...
        if (message.stopSequence != null && message.hasOwnProperty("stopSequence"))
          if (!$util.isInteger(message.stopSequence)) return "stopSequence: integer expected";
        ...
        if (message.stopTimeProperties != null && message.hasOwnProperty("stopTimeProperties")) {
          let error = $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.verify(
            message.stopTimeProperties,
            long + 1
          );
          if (error) return "stopTimeProperties." + error;
        }
        if (
          message[".transit_realtime.nyctStopTimeUpdate"] != null &&
          message.hasOwnProperty(".transit_realtime.nyctStopTimeUpdate")
        ) {
          let error = $root.transit_realtime.NyctStopTimeUpdate.verify(
            message[".transit_realtime.nyctStopTimeUpdate"],
            long + 1
          );
          if (error) return ".transit_realtime.nyctStopTimeUpdate." + error;
        }
        return null;
      };
      ...
      StopTimeUpdate.fromObject = function fromObject(object, long) {
        ...
        if (object.stopTimeProperties != null) {
          if (typeof object.stopTimeProperties !== "object")
            throw TypeError(
              ".transit_realtime.TripUpdate.StopTimeUpdate.stopTimeProperties: object expected"
            );
          message.stopTimeProperties =
            $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.fromObject(
        ...
        if (object[".transit_realtime.nyctStopTimeUpdate"] != null) {
          if (typeof object[".transit_realtime.nyctStopTimeUpdate"] !== "object")
            throw TypeError(
              ".transit_realtime.TripUpdate.StopTimeUpdate..transit_realtime.nyctStopTimeUpdate: object expected"
            );
          message[".transit_realtime.nyctStopTimeUpdate"] =
            $root.transit_realtime.NyctStopTimeUpdate.fromObject(
              object[".transit_realtime.nyctStopTimeUpdate"],
              long + 1
            );
        }
        return message;
      ...
      StopTimeUpdate.toObject = function toObject(message, options) {
        ...
        if (message.stopTimeProperties != null && message.hasOwnProperty("stopTimeProperties"))
          object.stopTimeProperties =
            $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties.toObject(
              message.stopTimeProperties,
              options
            );
        if (
          ...
          object[".transit_realtime.nyctStopTimeUpdate"] =
            $root.transit_realtime.NyctStopTimeUpdate.toObject(
              message[".transit_realtime.nyctStopTimeUpdate"],
              options
            );
        return object;
      ...
      StopTimeUpdate.StopTimeProperties = (function () {
        ...
        StopTimeProperties.encode = function encode(message, writer) {
          if (!writer) writer = $Writer.create();
          if (
            message.assignedStopId != null &&
            Object.hasOwnProperty.call(message, "assignedStopId")
          )
        ...
        StopTimeProperties.decode = function decode(reader, length, error, long) {
          ...
          if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
          let end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties();
          while (reader.pos < end) {
            let tag = reader.uint32();
            if (tag === error) break;
            switch (tag >>> 3) {
        ...
        StopTimeProperties.verify = function verify(message, long) {
          ...
          if (message.assignedStopId != null && message.hasOwnProperty("assignedStopId"))
            if (!$util.isString(message.assignedStopId)) return "assignedStopId: string expected";
          return null;
        };
        ...
        StopTimeProperties.fromObject = function fromObject(object, long) {
          ...
          if (object.assignedStopId != null) message.assignedStopId = String(object.assignedStopId);
          return message;
        };
        ...
        StopTimeProperties.toObject = function toObject(message, options) {
          if (!options) options = {};
          let object = {};
          if (options.defaults) object.assignedStopId = "";
          if (message.assignedStopId != null && message.hasOwnProperty("assignedStopId"))
    ...
    TripUpdate.TripProperties = (function () {
      ...
      TripProperties.decode = function decode(reader, length, error, long) {
        ...
        if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.transit_realtime.TripUpdate.TripProperties();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      TripProperties.verify = function verify(message, long) {
        ...
        if (message.startDate != null && message.hasOwnProperty("startDate"))
          if (!$util.isString(message.startDate)) return "startDate: string expected";
        if (message.startTime != null && message.hasOwnProperty("startTime"))
          if (!$util.isString(message.startTime)) return "startTime: string expected";
        return null;
      };
      ...
      TripProperties.fromObject = function fromObject(object, long) {
        if (object instanceof $root.transit_realtime.TripUpdate.TripProperties) return object;
        if (long === undefined) long = 0;
        if (long > $util.recursionLimit) throw Error("maximum nesting depth exceeded");
  ...
  transit_realtime.VehiclePosition = (function () {
    ...
    VehiclePosition.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "currentStopSequence")
      )
      ...
      if (
        message.occupancyPercentage != null &&
        Object.hasOwnProperty.call(message, "occupancyPercentage")
      )
      ...
      if (message.multiCarriageDetails != null && message.multiCarriageDetails.length)
        for (let i = 0; i < message.multiCarriageDetails.length; ++i)
          $root.transit_realtime.VehiclePosition.CarriageDetails.encode(
            message.multiCarriageDetails[i],
        ...
        switch (tag >>> 3) {
          ...
          case 11: {
            ...
            message.multiCarriageDetails.push(
              $root.transit_realtime.VehiclePosition.CarriageDetails.decode(
                reader,
                reader.uint32(),
                undefined,
                long + 1
    ...
    VehiclePosition.verify = function verify(message, long) {
      ...
      if (message.multiCarriageDetails != null && message.hasOwnProperty("multiCarriageDetails")) {
        ...
        for (let i = 0; i < message.multiCarriageDetails.length; ++i) {
          let error = $root.transit_realtime.VehiclePosition.CarriageDetails.verify(
            message.multiCarriageDetails[i],
            long + 1
          );
          if (error) return "multiCarriageDetails." + error;
        }
      }
      return null;
    };
      ...
      if (object.multiCarriageDetails) {
        ...
        for (let i = 0; i < object.multiCarriageDetails.length; ++i) {
          if (typeof object.multiCarriageDetails[i] !== "object")
            throw TypeError(
              ".transit_realtime.VehiclePosition.multiCarriageDetails: object expected"
            );
          message.multiCarriageDetails[i] =
            $root.transit_realtime.VehiclePosition.CarriageDetails.fromObject(
              object.multiCarriageDetails[i],
              long + 1
            );
        }
      }
    ...
    VehiclePosition.toObject = function toObject(message, options) {
      if (!options) options = {};
      let object = {};
      if (options.arrays || options.defaults) object.multiCarriageDetails = [];
      if (options.defaults) {
        object.trip = null;
      ...
      if (message.currentStatus != null && message.hasOwnProperty("currentStatus"))
        object.currentStatus =
          options.enums === String
            ? $root.transit_realtime.VehiclePosition.VehicleStopStatus[message.currentStatus] ===
              undefined
      ...
      if (message.congestionLevel != null && message.hasOwnProperty("congestionLevel"))
        object.congestionLevel =
          options.enums === String
            ? $root.transit_realtime.VehiclePosition.CongestionLevel[message.congestionLevel] ===
              undefined
      ...
      if (message.occupancyStatus != null && message.hasOwnProperty("occupancyStatus"))
        object.occupancyStatus =
          options.enums === String
            ? $root.transit_realtime.VehiclePosition.OccupancyStatus[message.occupancyStatus] ===
              undefined
      ...
      if (message.multiCarriageDetails && message.multiCarriageDetails.length) {
        ...
        for (let j = 0; j < message.multiCarriageDetails.length; ++j)
          object.multiCarriageDetails[j] =
            $root.transit_realtime.VehiclePosition.CarriageDetails.toObject(
              message.multiCarriageDetails[j],
              options
            );
      }
      return object;
    ...
    VehiclePosition.CarriageDetails = (function () {
      ...
      CarriageDetails.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "occupancyStatus")
        )
        ...
        if (
          message.carriageSequence != null &&
          Object.hasOwnProperty.call(message, "carriageSequence")
        )
      ...
      CarriageDetails.decode = function decode(reader, length, error, long) {
        ...
        if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.transit_realtime.VehiclePosition.CarriageDetails();
        while (reader.pos < end) {
          let tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      CarriageDetails.fromObject = function fromObject(object, long) {
        if (object instanceof $root.transit_realtime.VehiclePosition.CarriageDetails) return object;
        if (long === undefined) long = 0;
        if (long > $util.recursionLimit) throw Error("maximum nesting depth exceeded");
  ...
  transit_realtime.Alert = (function () {
    ...
    Alert.encode = function encode(message, writer) {
      ...
      if (
        message.ttsDescriptionText != null &&
        Object.hasOwnProperty.call(message, "ttsDescriptionText")
      )
        $root.transit_realtime.TranslatedString.encode(
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.activePeriod.push(
              $root.transit_realtime.TimeRange.decode(reader, reader.uint32(), undefined, long + 1)
            );
            break;
          }
          case 5: {
          ...
          case 12: {
            message.ttsHeaderText = $root.transit_realtime.TranslatedString.decode(
              reader,
              reader.uint32(),
              undefined,
              long + 1
          ...
          case 13: {
            message.ttsDescriptionText = $root.transit_realtime.TranslatedString.decode(
              reader,
              reader.uint32(),
              undefined,
              long + 1
    ...
    Alert.verify = function verify(message, long) {
      ...
      if (message.activePeriod != null && message.hasOwnProperty("activePeriod")) {
        ...
        for (let i = 0; i < message.activePeriod.length; ++i) {
          let error = $root.transit_realtime.TimeRange.verify(message.activePeriod[i], long + 1);
      ...
      if (message.headerText != null && message.hasOwnProperty("headerText")) {
        let error = $root.transit_realtime.TranslatedString.verify(message.headerText, long + 1);
      ...
      if (message.ttsHeaderText != null && message.hasOwnProperty("ttsHeaderText")) {
        let error = $root.transit_realtime.TranslatedString.verify(message.ttsHeaderText, long + 1);
        if (error) return "ttsHeaderText." + error;
      }
      if (message.ttsDescriptionText != null && message.hasOwnProperty("ttsDescriptionText")) {
        ...
        if (error) return "ttsDescriptionText." + error;
      }
    ...
    Alert.fromObject = function fromObject(object, long) {
      ...
      if (object.informedEntity) {
        ...
        for (let i = 0; i < object.informedEntity.length; ++i) {
          ...
          message.informedEntity[i] = $root.transit_realtime.EntitySelector.fromObject(
      ...
      if (object.ttsHeaderText != null) {
        ...
        message.ttsHeaderText = $root.transit_realtime.TranslatedString.fromObject(
          object.ttsHeaderText,
          long + 1
        );
      }
      if (object.ttsDescriptionText != null) {
        ...
        message.ttsDescriptionText = $root.transit_realtime.TranslatedString.fromObject(
          object.ttsDescriptionText,
          long + 1
        );
      }
    ...
    Alert.toObject = function toObject(message, options) {
      ...
      if (message.informedEntity && message.informedEntity.length) {
        ...
        for (let j = 0; j < message.informedEntity.length; ++j)
          object.informedEntity[j] = $root.transit_realtime.EntitySelector.toObject(
      ...
      if (message.cause != null && message.hasOwnProperty("cause"))
        object.cause =
          options.enums === String
            ? $root.transit_realtime.Alert.Cause[message.cause] === undefined
              ? message.cause
      ...
      if (message.effect != null && message.hasOwnProperty("effect"))
        object.effect =
          options.enums === String
            ? $root.transit_realtime.Alert.Effect[message.effect] === undefined
              ? message.effect
      ...
      if (message.ttsHeaderText != null && message.hasOwnProperty("ttsHeaderText"))
        object.ttsHeaderText = $root.transit_realtime.TranslatedString.toObject(
          message.ttsHeaderText,
          options
        );
      if (message.ttsDescriptionText != null && message.hasOwnProperty("ttsDescriptionText"))
        object.ttsDescriptionText = $root.transit_realtime.TranslatedString.toObject(
          message.ttsDescriptionText,
          options
        );
      if (message.severityLevel != null && message.hasOwnProperty("severityLevel"))
        object.severityLevel =
          options.enums === String
            ? $root.transit_realtime.Alert.SeverityLevel[message.severityLevel] === undefined
              ? message.severityLevel
              : $root.transit_realtime.Alert.SeverityLevel[message.severityLevel]
            : message.severityLevel;
      return object;
    };
  ...
  transit_realtime.TimeRange = (function () {
    ...
    TimeRange.fromObject = function fromObject(object, long) {
      ...
      if (object.start != null)
        if ($util.Long) (message.start = $util.Long.fromValue(object.start)).unsigned = true;
      ...
      if (object.end != null)
        if ($util.Long) (message.end = $util.Long.fromValue(object.end)).unsigned = true;
        ...
        if (typeof message.end === "number")
          ...
          object.end =
            options.longs === String
              ...
              : options.longs === Number
                ? new $util.LongBits(message.end.low >>> 0, message.end.high >>> 0).toNumber(true)
                : message.end;
      return object;
    };
  ...
  transit_realtime.Position = (function () {
    ...
    Position.verify = function verify(message, long) {
      ...
      if (message.bearing != null && message.hasOwnProperty("bearing"))
        if (typeof message.bearing !== "number") return "bearing: number expected";
      if (message.odometer != null && message.hasOwnProperty("odometer"))
        if (typeof message.odometer !== "number") return "odometer: number expected";
    ...
    Position.toObject = function toObject(message, options) {
      ...
      if (message.bearing != null && message.hasOwnProperty("bearing"))
        object.bearing =
          options.json && !isFinite(message.bearing) ? String(message.bearing) : message.bearing;
      if (message.odometer != null && message.hasOwnProperty("odometer"))
        object.odometer =
          options.json && !isFinite(message.odometer) ? String(message.odometer) : message.odometer;
      if (message.speed != null && message.hasOwnProperty("speed"))
        object.speed =
          options.json && !isFinite(message.speed) ? String(message.speed) : message.speed;
      return object;
    };
  ...
  transit_realtime.TripDescriptor = (function () {
    ...
    TripDescriptor.encode = function encode(message, writer) {
      ...
      if (
        message[".transit_realtime.nyctTripDescriptor"] != null &&
        Object.hasOwnProperty.call(message, ".transit_realtime.nyctTripDescriptor")
      )
        $root.transit_realtime.NyctTripDescriptor.encode(
    ...
    TripDescriptor.decode = function decode(reader, length, error, long) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 1001: {
            message[".transit_realtime.nyctTripDescriptor"] =
              $root.transit_realtime.NyctTripDescriptor.decode(
                reader,
                reader.uint32(),
                undefined,
                long + 1
    ...
    TripDescriptor.verify = function verify(message, long) {
      ...
      if (message.directionId != null && message.hasOwnProperty("directionId"))
        if (!$util.isInteger(message.directionId)) return "directionId: integer expected";
      if (message.startTime != null && message.hasOwnProperty("startTime"))
        if (!$util.isString(message.startTime)) return "startTime: string expected";
      if (message.startDate != null && message.hasOwnProperty("startDate"))
        if (!$util.isString(message.startDate)) return "startDate: string expected";
      ...
      if (
        message[".transit_realtime.nyctTripDescriptor"] != null &&
        message.hasOwnProperty(".transit_realtime.nyctTripDescriptor")
      ) {
        let error = $root.transit_realtime.NyctTripDescriptor.verify(
          message[".transit_realtime.nyctTripDescriptor"],
          long + 1
        );
        if (error) return ".transit_realtime.nyctTripDescriptor." + error;
      }
      return null;
    };
    ...
    TripDescriptor.fromObject = function fromObject(object, long) {
      ...
      if (object[".transit_realtime.nyctTripDescriptor"] != null) {
        if (typeof object[".transit_realtime.nyctTripDescriptor"] !== "object")
          throw TypeError(
            ".transit_realtime.TripDescriptor..transit_realtime.nyctTripDescriptor: object expected"
          );
        message[".transit_realtime.nyctTripDescriptor"] =
          $root.transit_realtime.NyctTripDescriptor.fromObject(
            object[".transit_realtime.nyctTripDescriptor"],
            long + 1
          );
      }
      return message;
    ...
    TripDescriptor.toObject = function toObject(message, options) {
      ...
      if (
        ...
        object[".transit_realtime.nyctTripDescriptor"] =
          $root.transit_realtime.NyctTripDescriptor.toObject(
            message[".transit_realtime.nyctTripDescriptor"],
            options
          );
      return object;
  ...
  transit_realtime.VehicleDescriptor = (function () {
    ...
    VehicleDescriptor.verify = function verify(message, long) {
      ...
      if (message.licensePlate != null && message.hasOwnProperty("licensePlate"))
        if (!$util.isString(message.licensePlate)) return "licensePlate: string expected";
      return null;
    };
  ...
  transit_realtime.EntitySelector = (function () {
    ...
    EntitySelector.verify = function verify(message, long) {
      ...
      if (message.agencyId != null && message.hasOwnProperty("agencyId"))
        if (!$util.isString(message.agencyId)) return "agencyId: string expected";
      if (message.routeId != null && message.hasOwnProperty("routeId"))
        if (!$util.isString(message.routeId)) return "routeId: string expected";
      if (message.routeType != null && message.hasOwnProperty("routeType"))
        if (!$util.isInteger(message.routeType)) return "routeType: integer expected";
      if (message.trip != null && message.hasOwnProperty("trip")) {
        let error = $root.transit_realtime.TripDescriptor.verify(message.trip, long + 1);
        if (error) return "trip." + error;
      }
  ...
  transit_realtime.TranslatedString = (function () {
    ...
    TranslatedString.verify = function verify(message, long) {
      ...
      if (message.translation != null && message.hasOwnProperty("translation")) {
        ...
        for (let i = 0; i < message.translation.length; ++i) {
          let error = $root.transit_realtime.TranslatedString.Translation.verify(
            message.translation[i],
            long + 1
          );
    ...
    TranslatedString.fromObject = function fromObject(object, long) {
      ...
      if (object.translation) {
        ...
        for (let i = 0; i < object.translation.length; ++i) {
          ...
          message.translation[i] = $root.transit_realtime.TranslatedString.Translation.fromObject(
    ...
    TranslatedString.toObject = function toObject(message, options) {
      ...
      if (message.translation && message.translation.length) {
        ...
        for (let j = 0; j < message.translation.length; ++j)
          object.translation[j] = $root.transit_realtime.TranslatedString.Translation.toObject(
  ...
  transit_realtime.TripReplacementPeriod = (function () {
    ...
    TripReplacementPeriod.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "replacementPeriod")
      )
        $root.transit_realtime.TimeRange.encode(
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TripReplacementPeriod.decode = function decode(reader, length, error, long) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      if (long === undefined) long = 0;
      if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.transit_realtime.TripReplacementPeriod();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    TripReplacementPeriod.verify = function verify(message, long) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) return "maximum nesting depth exceeded";
      if (message.routeId != null && message.hasOwnProperty("routeId"))
      ...
      if (message.replacementPeriod != null && message.hasOwnProperty("replacementPeriod")) {
        let error = $root.transit_realtime.TimeRange.verify(message.replacementPeriod, long + 1);
     ...
     * @returns {transit_realtime.TripReplacementPeriod} TripReplacementPeriod
     */
    TripReplacementPeriod.fromObject = function fromObject(object, long) {
      if (object instanceof $root.transit_realtime.TripReplacementPeriod) return object;
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) throw Error("maximum nesting depth exceeded");
      ...
      if (object.replacementPeriod != null) {
        if (typeof object.replacementPeriod !== "object")
          throw TypeError(
            ".transit_realtime.TripReplacementPeriod.replacementPeriod: object expected"
          );
  ...
  transit_realtime.NyctFeedHeader = (function () {
    ...
    NyctFeedHeader.encode = function encode(message, writer) {
      ...
      if (message.tripReplacementPeriod != null && message.tripReplacementPeriod.length)
        for (let i = 0; i < message.tripReplacementPeriod.length; ++i)
          $root.transit_realtime.TripReplacementPeriod.encode(
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NyctFeedHeader.decode = function decode(reader, length, error, long) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      if (long === undefined) long = 0;
      if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.transit_realtime.NyctFeedHeader();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.tripReplacementPeriod.push(
              $root.transit_realtime.TripReplacementPeriod.decode(
                reader,
                reader.uint32(),
                undefined,
                long + 1
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    NyctFeedHeader.verify = function verify(message, long) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) return "maximum nesting depth exceeded";
      if (!$util.isString(message.nyctSubwayVersion)) return "nyctSubwayVersion: string expected";
      if (
        ...
        for (let i = 0; i < message.tripReplacementPeriod.length; ++i) {
          let error = $root.transit_realtime.TripReplacementPeriod.verify(
            message.tripReplacementPeriod[i],
            long + 1
          );
     ...
     * @returns {transit_realtime.NyctFeedHeader} NyctFeedHeader
     */
    NyctFeedHeader.fromObject = function fromObject(object, long) {
      if (object instanceof $root.transit_realtime.NyctFeedHeader) return object;
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) throw Error("maximum nesting depth exceeded");
      ...
      if (object.tripReplacementPeriod) {
        ...
        for (let i = 0; i < object.tripReplacementPeriod.length; ++i) {
          if (typeof object.tripReplacementPeriod[i] !== "object")
            throw TypeError(
              ".transit_realtime.NyctFeedHeader.tripReplacementPeriod: object expected"
            );
          message.tripReplacementPeriod[i] =
            $root.transit_realtime.TripReplacementPeriod.fromObject(
    ...
    NyctFeedHeader.toObject = function toObject(message, options) {
      ...
      if (message.tripReplacementPeriod && message.tripReplacementPeriod.length) {
        ...
        for (let j = 0; j < message.tripReplacementPeriod.length; ++j)
          object.tripReplacementPeriod[j] = $root.transit_realtime.TripReplacementPeriod.toObject(
  ...
  transit_realtime.NyctTripDescriptor = (function () {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NyctTripDescriptor.decode = function decode(reader, length, error, long) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      if (long === undefined) long = 0;
      if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.transit_realtime.NyctTripDescriptor();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    NyctTripDescriptor.verify = function verify(message, long) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) return "maximum nesting depth exceeded";
      ...
      if (message.isAssigned != null && message.hasOwnProperty("isAssigned"))
        if (typeof message.isAssigned !== "boolean") return "isAssigned: boolean expected";
     ...
     * @returns {transit_realtime.NyctTripDescriptor} NyctTripDescriptor
     */
    NyctTripDescriptor.fromObject = function fromObject(object, long) {
      if (object instanceof $root.transit_realtime.NyctTripDescriptor) return object;
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) throw Error("maximum nesting depth exceeded");
      let message = new $root.transit_realtime.NyctTripDescriptor();
      if (object.trainId != null) message.trainId = String(object.trainId);
      if (object.isAssigned != null) message.isAssigned = Boolean(object.isAssigned);
    ...
    NyctTripDescriptor.toObject = function toObject(message, options) {
      ...
      if (message.direction != null && message.hasOwnProperty("direction"))
        object.direction =
          options.enums === String
            ? $root.transit_realtime.NyctTripDescriptor.Direction[message.direction] === undefined
              ? message.direction
              : $root.transit_realtime.NyctTripDescriptor.Direction[message.direction]
            : message.direction;
      return object;
    };
  ...
  transit_realtime.NyctStopTimeUpdate = (function () {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    NyctStopTimeUpdate.decode = function decode(reader, length, error, long) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      if (long === undefined) long = 0;
      if (long > $Reader.recursionLimit) throw Error("maximum nesting depth exceeded");
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.transit_realtime.NyctStopTimeUpdate();
      while (reader.pos < end) {
        let tag = reader.uint32();
        if (tag === error) break;
        switch (tag >>> 3) {
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    NyctStopTimeUpdate.verify = function verify(message, long) {
      if (typeof message !== "object" || message === null) return "object expected";
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) return "maximum nesting depth exceeded";
      if (message.scheduledTrack != null && message.hasOwnProperty("scheduledTrack"))
        if (!$util.isString(message.scheduledTrack)) return "scheduledTrack: string expected";
      if (message.actualTrack != null && message.hasOwnProperty("actualTrack"))
        if (!$util.isString(message.actualTrack)) return "actualTrack: string expected";
      return null;
    };
     ...
     * @returns {transit_realtime.NyctStopTimeUpdate} NyctStopTimeUpdate
     */
    NyctStopTimeUpdate.fromObject = function fromObject(object, long) {
      if (object instanceof $root.transit_realtime.NyctStopTimeUpdate) return object;
      if (long === undefined) long = 0;
      if (long > $util.recursionLimit) throw Error("maximum nesting depth exceeded");
      let message = new $root.transit_realtime.NyctStopTimeUpdate();
      if (object.scheduledTrack != null) message.scheduledTrack = String(object.scheduledTrack);
      if (object.actualTrack != null) message.actualTrack = String(object.actualTrack);
      return message;
    };
