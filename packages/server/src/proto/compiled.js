    ...
    FeedHeader.decode = function decode(reader, length, error) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 1001: {
            message[".transit_realtime.nyctFeedHeader"] =
              $root.transit_realtime.NyctFeedHeader.decode(reader, reader.uint32());
            break;
          }
          default:
            reader.skipType(tag & 7);
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.stopTimeUpdate.push(
              $root.transit_realtime.TripUpdate.StopTimeUpdate.decode(reader, reader.uint32())
            );
            break;
          }
          case 4: {
      ...
      StopTimeUpdate.decode = function decode(reader, length, error) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 1001: {
              message[".transit_realtime.nyctStopTimeUpdate"] =
                $root.transit_realtime.NyctStopTimeUpdate.decode(reader, reader.uint32());
              break;
            }
            default:
              reader.skipType(tag & 7);
        ...
        switch (tag >>> 3) {
          ...
          case 11: {
            ...
            message.multiCarriageDetails.push(
              $root.transit_realtime.VehiclePosition.CarriageDetails.decode(reader, reader.uint32())
            );
            break;
          }
          default:
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            ...
            message.informedEntity.push(
              $root.transit_realtime.EntitySelector.decode(reader, reader.uint32())
            );
            break;
          }
          case 6: {
    ...
    TripDescriptor.decode = function decode(reader, length, error) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 1001: {
            message[".transit_realtime.nyctTripDescriptor"] =
              $root.transit_realtime.NyctTripDescriptor.decode(reader, reader.uint32());
            break;
          }
          default:
            reader.skipType(tag & 7);
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            message.translation.push(
              $root.transit_realtime.TranslatedString.Translation.decode(reader, reader.uint32())
            );
            break;
          }
          default:
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.tripReplacementPeriod.push(
              $root.transit_realtime.TripReplacementPeriod.decode(reader, reader.uint32())
            );
            break;
          }
          default:
