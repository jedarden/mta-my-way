 ...
 * A compact RecommendationWhy strip below the grid carries the engine's
 * reason, confidence, staleness and time saved.
 */
...
export function RouteComparison({ analysis }: RouteComparisonProps) {
  ...
  return (
    <>
      ...
      {/* Why the engine picked one over the other */}
      <RecommendationWhy details={recommendationDetails} compact />
    </>
  );
}
