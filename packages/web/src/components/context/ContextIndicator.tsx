...
export function ContextIndicator({
  ...
  const sizeClasses = compact ? "px-2 py-1 text-11 gap-1.5" : "px-2.5 py-1.5 text-13 gap-2";
  ...
  return (
    <div
      className={`inline-flex items-center rounded-full bg-surface dark:bg-dark-surface ${sizeClasses}`}
      role="status"
