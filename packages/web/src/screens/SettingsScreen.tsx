  ...
  return (
    <div className="p-4">
      ...
      <section aria-labelledby="data-heading" className="mb-6">
        <h2 id="data-heading" className="text-lg font-semibold mb-4 text-text-primary dark:text-dark-text-primary">
          Data
        </h2>
        <div className="bg-surface dark:bg-dark-surface rounded-lg">
          <div className="p-4 border-b border-background dark:border-dark-background">
      ...
      <section aria-labelledby="notifications-heading" className="mb-6">
        <h2 id="notifications-heading" className="text-lg font-semibold mb-4 text-text-primary dark:text-dark-text-primary">
          Notifications
        </h2>
        <div className="bg-surface dark:bg-dark-surface rounded-lg">
          <div className="p-4 border-b border-background dark:border-dark-background">
      ...
      <section aria-labelledby="about-heading">
        <h2 id="about-heading" className="text-lg font-semibold mb-4 text-text-primary dark:text-dark-text-primary">
          About
        </h2>
