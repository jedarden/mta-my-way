...
- Name: accessibility.e2e.ts >> Screen Reader Compatibility >> Live Regions >> should have live regions for announcements
- Location: accessibility.e2e.ts:51:5
...
Locator: locator('[role="status"][aria-live="polite"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="status"][aria-live="polite"]')
