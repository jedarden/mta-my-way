...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Real-time Updates >> should update ETA countdown over time
- Location: trip-tracking.e2e.ts:283:5
...
Call log:
  - waiting for locator('text=/\\d+ min/i').first()
