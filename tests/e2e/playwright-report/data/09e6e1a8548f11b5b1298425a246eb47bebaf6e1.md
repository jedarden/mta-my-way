...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Trip Actions >> should open share dialog when share is clicked
- Location: trip-tracking.e2e.ts:158:5

# Error details

```
Error: locator.count: Error: Unknown attribute "aria-label", must be one of "checked", "disabled", "expanded", "include-hidden", "level", "name", "pressed", "selected".
