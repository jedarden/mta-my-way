...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute List View >> should display trip journal link
- Location: commute-workflow.e2e.ts:64:5
...
Locator: locator('role=heading[name="Trip Journal"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('role=heading[name="Trip Journal"]')
