...
- Name: accessibility.e2e.ts >> Screen Reader Compatibility >> Interactive Elements >> should have accessible buttons with labels
- Location: accessibility.e2e.ts:132:5
...
Locator: locator('role=button[name="View alerts"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('role=button[name="View alerts"]')
