...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Trip Progress >> should show progress bar or indicator
- Location: trip-tracking.e2e.ts:64:5
...
Locator: locator('[role="progressbar"], [class*="progress"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="progressbar"], [class*="progress"]')
