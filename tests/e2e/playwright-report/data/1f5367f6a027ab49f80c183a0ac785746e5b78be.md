...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Data Persistence >> should handle missing journal data gracefully
- Location: subway-year.e2e.ts:666:5
...
Locator: locator('text=/No trips recorded/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/No trips recorded/i')
