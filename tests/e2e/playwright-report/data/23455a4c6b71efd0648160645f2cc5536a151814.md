...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Visual Design >> should use appropriate colors for progress states
- Location: fare-tracking.e2e.ts:499:5
...
Locator: locator('[role="progressbar"] > div')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="progressbar"] > div')
