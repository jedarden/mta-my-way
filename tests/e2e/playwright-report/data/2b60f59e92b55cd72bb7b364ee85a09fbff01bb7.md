...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Monthly Comparison >> should show unlimited pass comparison when pay-per-ride is better
- Location: fare-tracking.e2e.ts:195:5
...
Locator: locator('text=/saves|Pay-per-ride/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/saves|Pay-per-ride/i')
