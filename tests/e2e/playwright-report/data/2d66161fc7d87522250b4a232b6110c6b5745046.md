...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute Detail View >> should have back button to commute list
- Location: commute-workflow.e2e.ts:273:5
...
Locator: locator('role=button:has-text("Back")')
Expected: visible
InvalidSelectorError: Error while parsing selector `button:has-text("Back")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("Back")')
