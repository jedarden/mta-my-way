...
- Name: settings.e2e.ts >> Settings Screen >> Notification Settings >> should show quiet hours setting
- Location: settings.e2e.ts:205:5
...
Locator: locator('text=/quiet hours|do not disturb/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/quiet hours|do not disturb/i')
