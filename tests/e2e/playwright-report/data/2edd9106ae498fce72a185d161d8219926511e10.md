...
- Name: settings.e2e.ts >> Settings Screen >> Data Management >> should confirm before clearing data
- Location: settings.e2e.ts:293:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `button:has-text("Clear")` - unexpected symbol ":" at position 6
