...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Stats Details >> should display environmental impact section
- Location: subway-year.e2e.ts:400:5
...
Locator: locator('text=/Environmental Impact|CO₂ Saved/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Environmental Impact|CO₂ Saved/i')
