...
- Name: line-diagram.e2e.ts >> Line Diagram Screen >> Line Selection >> should allow switching between lines
- Location: line-diagram.e2e.ts:253:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `button:has-text(/A|C|E|2|3/), [role="menu"]` - unexpected symbol ":" at position 6
