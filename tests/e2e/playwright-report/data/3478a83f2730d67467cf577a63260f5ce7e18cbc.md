...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Stats Details >> should display reliability section
- Location: subway-year.e2e.ts:393:5
...
Locator: locator('text=/Reliability|Delay Days/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Reliability|Delay Days/i')
