...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Accessibility >> should have proper heading hierarchy
- Location: commute-workflow.e2e.ts:599:5
...
Locator: locator('role=heading[level="1"], role=heading[name="Commute Presets"]')
Expected: attached
InvalidSelectorError: Error while parsing selector `heading[level="1"], role=heading[name="Commute Presets"]` - unexpected symbol "," at position 18
...
Call log:
  ...
  - waiting for locator('role=heading[level="1"], role=heading[name="Commute Presets"]')
