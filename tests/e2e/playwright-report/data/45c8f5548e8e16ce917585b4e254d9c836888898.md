...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute List View >> should navigate to journal when button is clicked
- Location: commute-workflow.e2e.ts:71:5

# Error details

```
Error: page.click: InvalidSelectorError: Error while parsing selector `button:has-text("View Trip History")` - unexpected symbol ":" at position 6
...
Call log:
  - waiting for locator('role=button:has-text("View Trip History")')
