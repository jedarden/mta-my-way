...
- Name: settings.e2e.ts >> Settings Screen >> Data Management >> should show commutes section
- Location: settings.e2e.ts:246:5
...
Locator: locator('text=/commutes|your commutes/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/commutes|your commutes/i')
