...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show streak information
- Location: subway-year.e2e.ts:295:5
...
Locator: locator('text=/Longest Streak|Current Streak/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Longest Streak|Current Streak/i')
