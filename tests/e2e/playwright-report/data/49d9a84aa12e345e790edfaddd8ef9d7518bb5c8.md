...
- Name: settings.e2e.ts >> Settings Screen >> About Section >> should show license information
- Location: settings.e2e.ts:352:5
...
Locator: locator('text=/license|open source|MIT/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/license|open source|MIT/i')
