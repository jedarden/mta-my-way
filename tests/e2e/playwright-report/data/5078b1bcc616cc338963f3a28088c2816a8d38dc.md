...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Share Functionality >> should have share button
- Location: subway-year.e2e.ts:434:5
...
Locator: locator('role=button:has-text("Share")')
Expected: visible
InvalidSelectorError: Error while parsing selector `button:has-text("Share")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("Share")')
