...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Accessibility >> should announce trip status to screen readers
- Location: trip-tracking.e2e.ts:321:5
...
Locator: locator('[aria-live], [role="status"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[aria-live], [role="status"]')
