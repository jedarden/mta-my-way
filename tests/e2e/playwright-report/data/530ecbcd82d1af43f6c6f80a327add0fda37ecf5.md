...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Error Handling >> should handle API errors gracefully
- Location: commute-workflow.e2e.ts:566:5
...
Locator: locator('text=/error|couldn\'t load|failed/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/error|couldn\'t load|failed/i')
