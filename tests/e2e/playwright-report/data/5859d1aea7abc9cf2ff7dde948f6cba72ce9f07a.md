...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Error Handling >> should handle missing trip ID gracefully
- Location: trip-tracking.e2e.ts:234:5
...
Expected: "/"
Received: "http://localhost:3001/trip/"
```
