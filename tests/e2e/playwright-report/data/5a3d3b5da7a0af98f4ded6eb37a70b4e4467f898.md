...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Share Functionality >> should trigger share when button is clicked
- Location: subway-year.e2e.ts:441:5

# Error details

```
Error: locator.click: InvalidSelectorError: Error while parsing selector `button:has-text("Share")` - unexpected symbol ":" at position 6
