...
- Name: settings.e2e.ts >> Settings Screen >> Theme Settings >> should show light/dark/system theme options
- Location: settings.e2e.ts:54:5
...
Locator: locator('text=/Light|Dark|System|Auto/i').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Light|Dark|System|Auto/i').first()
