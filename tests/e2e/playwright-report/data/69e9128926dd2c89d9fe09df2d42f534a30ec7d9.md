...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show time underground
- Location: subway-year.e2e.ts:247:5
...
Locator: locator('text=/Underground/i').locator('..')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Underground/i').locator('..')
