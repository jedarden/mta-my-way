...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Performance >> should load stats screen quickly
- Location: subway-year.e2e.ts:593:5
...
Call log:
  - waiting for locator('role=heading[name="Your Subway Year"]') to be visible
