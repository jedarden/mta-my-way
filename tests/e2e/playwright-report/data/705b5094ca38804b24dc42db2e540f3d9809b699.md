...
- Name: user-journeys.e2e.ts >> Station Detail Journey >> should add station to favorites from detail page
- Location: user-journeys.e2e.ts:107:3

# Error details

```
Error: locator.count: Error: Unknown attribute "aria-pressed", must be one of "checked", "disabled", "expanded", "include-hidden", "level", "name", "pressed", "selected".
