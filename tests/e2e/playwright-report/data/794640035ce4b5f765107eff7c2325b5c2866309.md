...
- Name: user-journeys.e2e.ts >> Full Stack Workflows >> complete workflow: home → station → refresh arrivals
- Location: user-journeys.e2e.ts:404:3
...
Call log:
  - waiting for locator('role=heading[name="Arrivals"]') to be visible
