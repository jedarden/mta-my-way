...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Active Trip Display >> should show destination name
- Location: trip-tracking.e2e.ts:30:5
...
Locator: locator('text=/To/i')
Expected: visible
Error: strict mode violation: locator('text=/To/i') resolved to 4 elements:
    1) <a href="#app" class="skip-link">Skip to main content</a> aka getByRole('link', { name: 'Skip to main content' })
    2) <h2>Top 5 Bots</h2> aka getByRole('heading', { name: 'Top 5 Bots' })
    3) <h2>Latest Stories</h2> aka getByRole('heading', { name: 'Latest Stories' })
    4) <a href="#/blog" class="btn small secondary">All stories →</a> aka getByRole('link', { name: 'All stories →' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=/To/i')
