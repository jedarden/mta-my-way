...
- Name: onboarding.e2e.ts >> Onboarding Flow >> Location Permission Step >> should advance to nearby stations when location is granted
- Location: onboarding.e2e.ts:106:5
