...
- Name: map.e2e.ts >> Map Screen >> Line Filtering >> should show filter button
- Location: map.e2e.ts:127:5
...
Locator: locator('role=button:has-text("Filter")').or(locator('role=button[aria-label*="filter" i]'))
Expected: visible
InvalidSelectorError: Error while parsing selector `button:has-text("Filter")` - unexpected symbol ":" at position 6
