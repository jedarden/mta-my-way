...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Carbon Savings Section >> should show carbon savings
- Location: subway-year.e2e.ts:329:5
...
Locator: locator('text=/CO₂ Saved|Carbon Savings|kg of CO₂/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/CO₂ Saved|Carbon Savings|kg of CO₂/i')
