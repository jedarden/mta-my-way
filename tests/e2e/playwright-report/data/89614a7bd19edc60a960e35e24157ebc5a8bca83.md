...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Performance >> should load commute list quickly
- Location: commute-workflow.e2e.ts:636:5
...
Call log:
  - waiting for locator('role=heading[name="Commute Presets"]') to be visible
