...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Time Window Selection >> should display time window selector
- Location: subway-year.e2e.ts:125:5
...
Locator: locator('role=button:has-text("This Month")')
Expected: attached
InvalidSelectorError: Error while parsing selector `button:has-text("This Month")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("This Month")')
