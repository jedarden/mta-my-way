...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show total trips
- Location: subway-year.e2e.ts:232:5
...
Locator: locator('text=/Trips Taken/i').locator('..')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Trips Taken/i').locator('..')
