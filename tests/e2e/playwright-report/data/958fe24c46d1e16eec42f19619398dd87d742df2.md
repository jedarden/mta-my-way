...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Data Persistence >> should persist fare data across page reloads
- Location: fare-tracking.e2e.ts:386:5
...
Call log:
  - waiting for locator('text=/\\d+\\/12/i').first()
