...
- Name: user-journeys.e2e.ts >> Error Handling >> should handle API errors gracefully
- Location: user-journeys.e2e.ts:451:3
...
Locator: locator('text=/not found|error/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/not found|error/i')
