...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute Creation >> should open commute editor when Add is clicked
- Location: commute-workflow.e2e.ts:116:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `button:has-text("Add")` - unexpected symbol ":" at position 6
