...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Carbon Savings Section >> should show environmental equivalents
- Location: subway-year.e2e.ts:336:5
...
Locator: locator('text=/trees|worth of trees/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/trees|worth of trees/i')
