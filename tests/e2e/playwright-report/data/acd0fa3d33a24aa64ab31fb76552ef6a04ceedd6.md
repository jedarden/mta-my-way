...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute Analysis >> should show transfer details
- Location: commute-workflow.e2e.ts:340:5
...
Locator: locator('text=/transfer|stop|arrive/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/transfer|stop|arrive/i')
