...
- Name: line-diagram.e2e.ts >> Line Diagram Screen >> Diagram Loading >> should show line name/identifier
- Location: line-diagram.e2e.ts:28:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `heading:has-text(/1 Train|Line 1|Broadway/i)` - unexpected symbol ":" at position 7
