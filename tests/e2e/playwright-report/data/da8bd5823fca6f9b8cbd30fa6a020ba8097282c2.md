...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Stats Details >> should display favorites section
- Location: subway-year.e2e.ts:386:5
...
Locator: locator('text=/Favorites|Most-Used/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Favorites|Most-Used/i')
