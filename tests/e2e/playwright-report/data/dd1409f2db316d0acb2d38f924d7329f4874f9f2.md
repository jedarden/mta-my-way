...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Trip Actions >> should have share button
- Location: trip-tracking.e2e.ts:149:5
...
Locator: locator('role=button[aria-label*="share" i]').or(locator('role=button:has-text("Share")'))
Expected: attached
Error: Unknown attribute "aria-label", must be one of "checked", "disabled", "expanded", "include-hidden", "level", "name", "pressed", "selected".
...
Call log:
  ...
  - waiting for locator('role=button[aria-label*="share" i]').or(locator('role=button:has-text("Share")'))
