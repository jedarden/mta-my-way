...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Visual Design >> should have tabular numbers for stats
- Location: subway-year.e2e.ts:525:5
...
Locator: locator('.tabular-nums').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.tabular-nums').first()
