...
- Name: line-diagram.e2e.ts >> Line Diagram Screen >> Accessibility >> should have proper heading structure
- Location: line-diagram.e2e.ts:474:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `heading[name="Line Diagram"], role=heading[name*="Train"]` - unexpected symbol "," at position 28
