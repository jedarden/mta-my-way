...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Error Handling >> should handle offline state during tracking
- Location: trip-tracking.e2e.ts:250:5
...
Locator: locator('role=heading[name="Live Trip"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('role=heading[name="Live Trip"]')
          ...
          - generic [ref=f1e6]:
            ...
            - generic [ref=f1e11]:
              ...
              - combobox [ref=f1e13]:
                ...
                - option "2x"
                - option "4x"
          - generic [ref=f1e16]: Loading replay...
          - link "AI Code Battle" [ref=f1e17] [cursor=pointer]:
            - /url: https://ai-code-battle.pages.dev
      - generic [ref=e24]:
        - paragraph [ref=e25]: Demo Replay — Watch a sample battle
        - link "Watch Full Replay →" [ref=e26] [cursor=pointer]:
          - /url: "#/watch/replays"
    - generic [ref=e27]:
      - generic [ref=e28]:
        - heading "Top 5 Bots" [level=2] [ref=e29]
        - paragraph [ref=e31]: No bots ranked yet
        - link "Full leaderboard →" [ref=e32] [cursor=pointer]:
          - /url: "#/leaderboard"
      - generic [ref=e33]:
        - heading "Latest Stories" [level=2] [ref=e34]
        - paragraph [ref=e36]: No stories yet
        - link "All stories →" [ref=e37] [cursor=pointer]:
          - /url: "#/blog"
```
