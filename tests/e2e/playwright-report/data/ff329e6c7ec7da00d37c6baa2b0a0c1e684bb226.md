...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Accessibility >> should announce progress to screen readers
- Location: fare-tracking.e2e.ts:478:5
...
Locator: locator('text=/8.*12|rides/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/8.*12|rides/i')
