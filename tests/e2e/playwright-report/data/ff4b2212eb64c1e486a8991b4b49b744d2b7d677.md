...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Fare Tracker Display >> should display fare tracker when rides are tracked
- Location: fare-tracking.e2e.ts:19:5
...
Locator: locator('text=/OMNY Fare Cap|Fare Cap/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/OMNY Fare Cap|Fare Cap/i')
