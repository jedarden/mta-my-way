...
- Name: accessibility.e2e.ts >> Screen Reader Compatibility >> Interactive Elements >> should have aria-pressed on toggle buttons
- Location: accessibility.e2e.ts:138:5
...
Call log:
  - waiting for locator('role=link[name="Home"]')
