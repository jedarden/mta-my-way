...
- Name: accessibility.e2e.ts >> Screen Reader Compatibility >> ARIA Landmarks >> should have proper landmark regions
- Location: accessibility.e2e.ts:22:5
...
Locator: locator('role=main[name="Main content"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('role=main[name="Main content"]')
