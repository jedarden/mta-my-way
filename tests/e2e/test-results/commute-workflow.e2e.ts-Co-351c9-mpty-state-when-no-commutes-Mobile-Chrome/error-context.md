...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute List View >> should show empty state when no commutes
- Location: commute-workflow.e2e.ts:32:5
...
Locator: locator('text=/No commutes|Add your first commute/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/No commutes|Add your first commute/i')
