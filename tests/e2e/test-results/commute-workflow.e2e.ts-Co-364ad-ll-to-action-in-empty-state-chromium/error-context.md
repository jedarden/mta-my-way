...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute List View >> should have 'Plan a commute' call to action in empty state
- Location: commute-workflow.e2e.ts:49:5
...
Locator: locator('role=button:has-text("Add")')
Expected: attached
InvalidSelectorError: Error while parsing selector `button:has-text("Add")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("Add")')
