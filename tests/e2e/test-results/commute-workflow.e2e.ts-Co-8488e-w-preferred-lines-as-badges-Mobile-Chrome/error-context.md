...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute Detail View >> should show preferred lines as badges
- Location: commute-workflow.e2e.ts:266:5
...
Locator: locator('[aria-label*="train"], span[class*="line"]').first()
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[aria-label*="train"], span[class*="line"]').first()
