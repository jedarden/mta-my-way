...
- Name: commute-workflow.e2e.ts >> Commute Workflow >> Commute Analysis >> should show walking comparison for short trips
- Location: commute-workflow.e2e.ts:350:5
...
Locator: locator('text=/walk|walking|pedestrian/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/walk|walking|pedestrian/i')
