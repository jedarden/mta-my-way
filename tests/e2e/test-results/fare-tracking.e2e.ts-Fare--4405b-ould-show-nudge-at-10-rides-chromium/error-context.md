...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Nudge Message >> should show nudge at 10 rides
- Location: fare-tracking.e2e.ts:259:5
...
Locator: locator('text=/Take 1 more ride|1 more round trip/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Take 1 more ride|1 more round trip/i')
