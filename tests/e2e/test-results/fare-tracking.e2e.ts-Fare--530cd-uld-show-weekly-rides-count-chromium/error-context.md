...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Fare Tracker Display >> should show weekly rides count
- Location: fare-tracking.e2e.ts:39:5
...
Locator: locator('text=/\\d+\\/\\d+|rides/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/\\d+\\/\\d+|rides/i')
