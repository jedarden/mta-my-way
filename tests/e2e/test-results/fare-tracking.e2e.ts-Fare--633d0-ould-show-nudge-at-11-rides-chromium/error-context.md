...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Nudge Message >> should show nudge at 11 rides
- Location: fare-tracking.e2e.ts:278:5
...
Locator: locator('text=/Take.*for free rides/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Take.*for free rides/i')
