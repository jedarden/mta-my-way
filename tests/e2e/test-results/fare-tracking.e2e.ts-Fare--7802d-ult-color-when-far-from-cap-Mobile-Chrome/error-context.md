...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Fare Cap States >> should show default color when far from cap
- Location: fare-tracking.e2e.ts:155:5
...
Locator: locator('text=/3\\/12|more until free/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/3\\/12|more until free/i')
