...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Monthly Comparison >> should show monthly rides count
- Location: fare-tracking.e2e.ts:176:5
...
Locator: locator('text=/This month.*rides|32.*rides/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/This month.*rides|32.*rides/i')
