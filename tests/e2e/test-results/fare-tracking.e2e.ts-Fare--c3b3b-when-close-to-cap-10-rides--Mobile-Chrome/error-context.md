...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Fare Cap States >> should show amber color when close to cap (10+ rides)
- Location: fare-tracking.e2e.ts:136:5
...
Locator: locator('text=/Take.*more.*for free/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Take.*more.*for free/i')
