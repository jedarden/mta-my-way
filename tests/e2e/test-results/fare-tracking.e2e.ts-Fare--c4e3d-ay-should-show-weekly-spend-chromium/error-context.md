...
- Name: fare-tracking.e2e.ts >> Fare Tracking >> Fare Tracker Display >> should show weekly spend
- Location: fare-tracking.e2e.ts:96:5
...
Locator: locator('text=/\\$\\d+\\.\\d+.*this week/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/\\$\\d+\\.\\d+.*this week/i')
