...
- Name: journal.e2e.ts >> Journal Screen >> Empty States >> should show empty state when no trips recorded
- Location: journal.e2e.ts:370:5

# Error details

```
Error: locator.count: Error: Unknown attribute "href", must be one of "checked", "disabled", "expanded", "include-hidden", "level", "name", "pressed", "selected".
          ...
          - generic [ref=f3e6]:
            ...
            - generic [ref=f3e11]:
              ...
              - combobox [ref=f3e13]:
                ...
                - option "4x"
          - generic [ref=f3e14]:
            - generic [ref=f3e15]: Failed to fetch
            - button "Retry" [ref=f3e16] [cursor=pointer]
          - link "AI Code Battle" [ref=f3e17] [cursor=pointer]:
