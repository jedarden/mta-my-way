...
- Name: line-diagram.e2e.ts >> Line Diagram Screen >> Line Selection >> should have line selector or menu
- Location: line-diagram.e2e.ts:240:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `button:has-text("Filter")` - unexpected symbol ":" at position 6
