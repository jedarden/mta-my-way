...
- Name: onboarding.e2e.ts >> Onboarding Flow >> Welcome Screen >> should have Get Started and Skip buttons
- Location: onboarding.e2e.ts:41:5
...
Locator: locator('role=button:has-text("Get Started")')
Expected: visible
InvalidSelectorError: Error while parsing selector `button:has-text("Get Started")` - unexpected symbol ":" at position 6
