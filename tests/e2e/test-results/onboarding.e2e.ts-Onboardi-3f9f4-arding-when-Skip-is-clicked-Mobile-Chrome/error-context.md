...
- Name: onboarding.e2e.ts >> Onboarding Flow >> Push Notifications Step >> should complete onboarding when Skip is clicked
- Location: onboarding.e2e.ts:500:5
  ...
  - generic [ref=e14]:
    ...
    - generic [ref=e21]:
      - iframe [ref=e23]:
        - generic [ref=f4e2]:
          - generic [ref=f4e6]:
            - button "Play" [disabled] [ref=f4e7]
            - button "Reset" [disabled] [ref=f4e8]
            - generic [ref=f4e9]: 0 / 0
            - generic [ref=f4e10]:
              - generic [ref=f4e11]: "Speed:"
              - combobox [ref=f4e12]:
                - option "0.5x"
                - option "1x" [selected]
                - option "2x"
                - option "4x"
          - generic [ref=f4e13]:
            - generic [ref=f4e14]: Failed to fetch
            - button "Retry" [ref=f4e15] [cursor=pointer]
          - link "AI Code Battle" [ref=f4e16] [cursor=pointer]:
