...
- Name: onboarding.e2e.ts >> Onboarding Flow >> Push Notifications Step >> should complete onboarding when notifications are enabled
- Location: onboarding.e2e.ts:488:5
