...
- Name: pwa-features.e2e.ts >> PWA Features >> Offline Functionality >> should cache key routes for offline access
- Location: pwa-features.e2e.ts:118:5

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at http://localhost:3001/
Call log:
