...
- Name: pwa-features.e2e.ts >> PWA Features >> Background Sync >> should support background sync for push subscriptions
- Location: pwa-features.e2e.ts:275:5

# Error details

```
Error: page.evaluate: TypeError: Cannot use 'in' operator to search for 'sync' in undefined
