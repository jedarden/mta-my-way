...
- Name: settings.e2e.ts >> Settings Screen >> Notification Settings >> should show notification permission status
- Location: settings.e2e.ts:176:5
...
Locator: locator('text=/enabled|disabled|permission/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/enabled|disabled|permission/i')
