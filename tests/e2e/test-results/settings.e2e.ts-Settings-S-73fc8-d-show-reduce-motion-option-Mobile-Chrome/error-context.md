...
- Name: settings.e2e.ts >> Settings Screen >> Accessibility Settings >> should show reduce motion option
- Location: settings.e2e.ts:361:5
...
Locator: locator('text=/reduce motion|animation/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/reduce motion|animation/i')
