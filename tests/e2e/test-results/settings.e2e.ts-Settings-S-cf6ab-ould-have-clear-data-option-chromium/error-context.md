...
- Name: settings.e2e.ts >> Settings Screen >> Data Management >> should have clear data option
- Location: settings.e2e.ts:284:5
...
Locator: locator('role=button:has-text("Clear")').or(locator('text=/clear data|reset|delete all/i'))
Expected: attached
InvalidSelectorError: Error while parsing selector `button:has-text("Clear")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("Clear")').or(locator('text=/clear data|reset|delete all/i'))
