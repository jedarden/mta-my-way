...
- Name: settings.e2e.ts >> Settings Screen >> Notification Settings >> should show alert severity filter
- Location: settings.e2e.ts:230:5
...
Locator: locator('text=/severity|alert level|filter/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/severity|alert level|filter/i')
