...
- Name: settings.e2e.ts >> Settings Screen >> Data Management >> should have export data option
- Location: settings.e2e.ts:253:5
...
Locator: locator('role=button:has-text("Export")').or(locator('text=/export data|download/i'))
Expected: attached
InvalidSelectorError: Error while parsing selector `button:has-text("Export")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("Export")').or(locator('text=/export data|download/i'))
