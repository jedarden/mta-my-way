...
- Name: settings.e2e.ts >> Settings Screen >> Display Preferences >> should show refresh interval setting
- Location: settings.e2e.ts:139:5
...
Locator: locator('text=/refresh|update|interval/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/refresh|update|interval/i')
