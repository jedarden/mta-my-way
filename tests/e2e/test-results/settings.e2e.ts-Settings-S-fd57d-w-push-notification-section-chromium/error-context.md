...
- Name: settings.e2e.ts >> Settings Screen >> Notification Settings >> should show push notification section
- Location: settings.e2e.ts:169:5
...
Locator: locator('text=/push notification|alerts|notify/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/push notification|alerts|notify/i')
