...
- Name: settings.e2e.ts >> Settings Screen >> About Section >> should have links to support/privacy
- Location: settings.e2e.ts:339:5

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `link:has-text("Support")` - unexpected symbol ":" at position 4
