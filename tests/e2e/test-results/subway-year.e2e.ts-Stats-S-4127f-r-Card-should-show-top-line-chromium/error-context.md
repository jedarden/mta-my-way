...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show top line
- Location: subway-year.e2e.ts:274:5
...
Locator: locator('text=/Top Line|Most-Used Line/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Top Line|Most-Used Line/i')
