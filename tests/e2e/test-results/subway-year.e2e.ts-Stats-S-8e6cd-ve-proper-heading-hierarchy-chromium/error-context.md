...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Accessibility >> should have proper heading hierarchy
- Location: subway-year.e2e.ts:559:5
...
Locator: locator('role=heading[name="Your Subway Year"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('role=heading[name="Your Subway Year"]')
