...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show top station
- Location: subway-year.e2e.ts:267:5
...
Locator: locator('text=/Top Station|Most-Used Station/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Top Station|Most-Used Station/i')
