...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Visual Design >> should have proper contrast on card
- Location: subway-year.e2e.ts:512:5
...
Call log:
  - waiting for locator('.from-\\[\\#0039A6\\]').first()
