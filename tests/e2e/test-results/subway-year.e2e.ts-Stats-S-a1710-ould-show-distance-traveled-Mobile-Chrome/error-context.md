...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show distance traveled
- Location: subway-year.e2e.ts:260:5
...
Locator: locator('text=/Distance|km|mi/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Distance|km|mi/i')
