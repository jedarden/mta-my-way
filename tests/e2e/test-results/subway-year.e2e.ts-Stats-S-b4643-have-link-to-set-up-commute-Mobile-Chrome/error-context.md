...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Empty State >> should have link to set up commute
- Location: subway-year.e2e.ts:87:5
...
Locator: locator('role=button:has-text("Set up a commute")')
Expected: attached
InvalidSelectorError: Error while parsing selector `button:has-text("Set up a commute")` - unexpected symbol ":" at position 6
...
Call log:
  ...
  - waiting for locator('role=button:has-text("Set up a commute")')
