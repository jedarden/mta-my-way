...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Time Window Selection >> should allow switching time windows
- Location: subway-year.e2e.ts:136:5

# Error details

```
Error: locator.click: InvalidSelectorError: Error while parsing selector `button:has-text("This Month")` - unexpected symbol ":" at position 6
