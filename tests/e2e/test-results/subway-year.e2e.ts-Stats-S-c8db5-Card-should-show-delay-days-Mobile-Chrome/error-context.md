...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Subway Year Card >> should show delay days
- Location: subway-year.e2e.ts:288:5
...
Locator: locator('text=/Delay Days/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Delay Days/i')
