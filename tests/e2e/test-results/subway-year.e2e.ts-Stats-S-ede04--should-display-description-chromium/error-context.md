...
- Name: subway-year.e2e.ts >> Stats / Subway Year Screen >> Navigation >> should display description
- Location: subway-year.e2e.ts:57:5
...
Locator: locator('text=/personalized summary|subway commute/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/personalized summary|subway commute/i')
