...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Active Trip Display >> should show trip timeline
- Location: trip-tracking.e2e.ts:46:5
...
Locator: locator('[role="list"], [class*="timeline"], [class*="stops"]')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="list"], [class*="timeline"], [class*="stops"]')
