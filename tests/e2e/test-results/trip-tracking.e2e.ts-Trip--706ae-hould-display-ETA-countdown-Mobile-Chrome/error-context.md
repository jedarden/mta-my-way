...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Active Trip Display >> should display ETA countdown
- Location: trip-tracking.e2e.ts:38:5
...
Locator: locator('text=/\\d+ min|Arriving|Now/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/\\d+ min|Arriving|Now/i')
