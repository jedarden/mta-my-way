...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Trip Prediction >> should display adjusted ETA when prediction exists
- Location: trip-tracking.e2e.ts:393:5
...
Locator: locator('text=/estimated|~\\d+ min/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/estimated|~\\d+ min/i')
