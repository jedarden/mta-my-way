...
- Name: trip-tracking.e2e.ts >> Trip Tracking Screen >> Trip Progress >> should display remaining stops count
- Location: trip-tracking.e2e.ts:72:5
...
Locator: locator('text=/\\d+ stops?/i')
Expected: attached
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/\\d+ stops?/i')
