...
- Name: user-journeys.e2e.ts >> Commute Journey >> should navigate to commute details
- Location: user-journeys.e2e.ts:344:3

# Error details

```
Error: locator.count: InvalidSelectorError: Error while parsing selector `article:has-text("commute")` - unexpected symbol ":" at position 7
