...
- Name: user-journeys.e2e.ts >> Favorites Management >> should view favorites on home screen
- Location: user-journeys.e2e.ts:173:3
...
Locator: locator('role=heading[name="Your Stations"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('role=heading[name="Your Stations"]')
