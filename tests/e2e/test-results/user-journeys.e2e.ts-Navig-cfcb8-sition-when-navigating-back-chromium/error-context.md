...
- Name: user-journeys.e2e.ts >> Navigation Journey >> should maintain scroll position when navigating back
- Location: user-journeys.e2e.ts:259:3
...
Call log:
  - waiting for locator('role=link[name="Go back"]')
