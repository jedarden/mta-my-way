...
- Name: user-journeys.e2e.ts >> Search Journey >> should click a search result and navigate to station detail
- Location: user-journeys.e2e.ts:51:3
...
Call log:
  - waiting for locator('role=searchbox[name="Search stations"]')
